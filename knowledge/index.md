...
- [Phase 0 Remainder Issues](wiki/syntheses/phase0-remainder-issues.md) — Phase 0 残実装の承認済み local issue ledger、blocker graph、P0R-001 から P0R-012 の実装結果。
- [Phase 0 Source Probe Feasibility Report](wiki/syntheses/phase0-source-probe-feasibility-report.md) — Roadmap 対象 source family 7/7 の fixture coverage と Phase 0 local completion 判定。
...
- [Phase 0 P0R-005 Execution Handoff](wiki/syntheses/phase0-remainder-p0r-005-execution-handoff.md) — 都議会 提出議案・議決結果 probe の Execution Plan Gate artifact と実行境界。
...
- [Phase 0 P0R-010 Execution Handoff](wiki/syntheses/phase0-remainder-p0r-010-execution-handoff.md) — 監査 source / `AuditFindingCandidate` probe の Execution Plan Gate artifact と実行境界。
- [Phase 0 P0R-011 Execution Handoff](wiki/syntheses/phase0-remainder-p0r-011-execution-handoff.md) — 監査指摘とアプリ計算 signal の保存分離 contract の Execution Plan Gate artifact と実行境界。
- [Phase 0 P0R-012 Execution Handoff](wiki/syntheses/phase0-remainder-p0r-012-execution-handoff.md) — Phase 0 feasibility report / coverage CLI の Execution Plan Gate artifact と実行境界。
...
- [Phase 0 Remainder Issues](wiki/syntheses/phase0-remainder-issues.md) — Phase 0 残実装の承認済み local issue ledger、P0R-001 から P0R-012 の実装結果、blocker graph。
  検索語: Phase 0, issue ledger, blocker graph, P0R, sample artifact, EvidenceItem, RawArtifact, MinIO, 残実装, 実装計画
- [Phase 0 Source Probe Feasibility Report](wiki/syntheses/phase0-source-probe-feasibility-report.md) — Roadmap 対象 source family 7/7 の fixture coverage と Phase 0 local completion 判定を記録する。
  検索語: Phase 0, fixture-report, coverage report, source family, complete, tokyo_metro_grants, tokyo_audit_reports, RawArtifact, EvidenceItem, feasibility, 完了判定
...
- [Phase 0 P0R-005 Execution Handoff](wiki/syntheses/phase0-remainder-p0r-005-execution-handoff.md) — `P0R-005` 都議会 提出議案・議決結果 probe の input packet / execution envelope への入口。
  検索語: Phase 0, P0R-005, execution packet, execution envelope, assembly bills, decision result, bill_decision_observed, VotePosition guard, 実行計画, ハンドオフ
- [Phase 0 P0R-006 Execution Handoff](wiki/syntheses/phase0-remainder-p0r-006-execution-handoff.md) — `P0R-006` 選挙公報・選挙結果 probe の input packet / execution envelope への入口。
  検索語: Phase 0, P0R-006, execution packet, execution envelope, election result, public bulletin, Candidate, ElectionResult, auto merge guard, 実行計画, ハンドオフ
- [Phase 0 P0R-007 Execution Handoff](wiki/syntheses/phase0-remainder-p0r-007-execution-handoff.md) — `P0R-007` 政治資金収支報告書 probe の input packet / execution envelope への入口。
...
- [Phase 0 P0R-010 Execution Handoff](wiki/syntheses/phase0-remainder-p0r-010-execution-handoff.md) — `P0R-010` 監査 source / `AuditFindingCandidate` probe の input packet / execution envelope への入口。
  検索語: Phase 0, P0R-010, execution packet, execution envelope, audit source, AuditFindingCandidate, official wording, SpendingReviewSignal guard, 実行計画, ハンドオフ
- [Phase 0 P0R-011 Execution Handoff](wiki/syntheses/phase0-remainder-p0r-011-execution-handoff.md) — `P0R-011` 監査指摘とアプリ計算 signal の保存分離 contract の input packet / execution envelope への入口。
  検索語: Phase 0, P0R-011, execution packet, execution envelope, AuditFindingCandidate, SpendingReviewSignalCandidate, storage separation, public UI guard, 実行計画, ハンドオフ
- [Phase 0 P0R-012 Execution Handoff](wiki/syntheses/phase0-remainder-p0r-012-execution-handoff.md) — `P0R-012` Phase 0 feasibility report / coverage CLI の input packet / execution envelope への入口。
  検索語: Phase 0, P0R-012, execution packet, execution envelope, fixture-report, coverage CLI, feasibility report, source family, blocked reason, 実行計画, ハンドオフ
